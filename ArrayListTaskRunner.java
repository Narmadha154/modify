...
public class ArrayListTaskRunner{
 ...
 case 12:
       ...
       ArrayList<String> secondList2=createStringArrayList();
       ArrayList<String> thirdList=ArrayListTask.createThreeArrayList(list9,secondList2);
  ...
  case 13:
       ...
       ArrayList<String> secondArrList=createStringArrayList();
       ArrayList<String> thirdArrList=ArrayListTask.createThirdArrayList(list10,secondArrList);
       System.out.println("Third ArrayList elements:");
 ...
 case 15:
       ...
       break;
 case 16:
        ArrayList<Long> longList1=createLongArrayList();
       System.out.println("Enter the start index:");
       int stIndex=sc.nextInt();
       System.out.println("Enter the end index:");
       int edIndex=sc.nextInt();
       ArrayList<Long> longArrayList=ArrayListTask.removeLongValue(longList1,stIndex,edIndex);
